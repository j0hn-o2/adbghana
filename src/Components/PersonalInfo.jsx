...
//                 <select value={selectedGenders} onChange={(e) => setSelectedGenders(e.target.value)} id="nationality" name="nationality" className='select-personal' defaultValue="Ghana" required>
